...
void set_default_settings()
{
	...
	settings->setDefault("font_path", porting::getDataPath("fonts" DIR_DELIM "F77MinecraftRegular.ttf"));
	settings->setDefault("font_path_italic", porting::getDataPath("fonts" DIR_DELIM "F77MinecraftRegular.ttf"));
	settings->setDefault("font_path_bold", porting::getDataPath("fonts" DIR_DELIM "F77MinecraftRegular.ttf"));
	settings->setDefault("font_path_bold_italic", porting::getDataPath("fonts" DIR_DELIM "F77MinecraftRegular.ttf"));
	...
	settings->setDefault("mono_font_path", porting::getDataPath("fonts" DIR_DELIM "Monocraft.ttf"));
	settings->setDefault("mono_font_path_italic", porting::getDataPath("fonts" DIR_DELIM "Monocraft.ttf"));
	settings->setDefault("mono_font_path_bold", porting::getDataPath("fonts" DIR_DELIM "Monocraft.ttf"));
	settings->setDefault("mono_font_path_bold_italic", porting::getDataPath("fonts" DIR_DELIM "Monocraft.ttf"));
	...
	settings->setDefault("mono_font_size", "11");
