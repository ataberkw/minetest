...
* After 5.4.2:
    * `/sdcard/Android/data/com.mcpeturk.dilsecici/` or `/storage/emulated/0/Android/data/com.mcpeturk.dilsecici/` if stored on the device
    * `/storage/emulated/(varying folder name)/Android/data/com.mcpeturk.dilsecici/` if stored on the SD card
