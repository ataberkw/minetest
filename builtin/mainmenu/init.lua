...
defaultguitexturedir = core.get_texturepath_share() .. DIR_DELIM .. "base" ..
					   DIR_DELIM .. "pack" .. DIR_DELIM .. "gui" .. DIR_DELIM
...
local function init_globals()
	...
	-- Create main tabview
	local tv_main = tabview_create("maintab", {x = 20, y = 10}, {x = 0, y = 0})

	tv_main:set_autosave_tab(true)
    tv_main:add(tabs.play) -- This is Finecraft's local_game tab.
